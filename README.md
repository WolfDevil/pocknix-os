...
- **Bleeding edge.** Packages come straight from Arch Linux ARM, and key components like Mesa
  ...
  running the freshest packages possible is important. For the same reason, updates ship as
  packages rather than system images: fixes and improvements land the moment they are ready,
  for speed of iteration in a niche this new.
